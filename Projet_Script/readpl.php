...
#div2 #s2 {
    ...
    <body style="background-color: rgba(15, 23, 43, .9);">
        <nav>
            <div class="menu">
              ...
              <ul>
                ...
                <li><a href="readcm.php">Commands</a></li>
        ...
        <div >
    <h2 style='color:#ffc40c ;'>List of products from database</h2>
    <!--<a  class="btn btn-primary" href="create.php" role="button">Signup</a>-->
    <a   href="creatpl.php" role="button"><button>Add Meal</button></a>
    ...
    <table class="table">
       ...
       $plats = plat::selectAllPlat('plat',$connex->conn);
        ...
        foreach($plats as $row) {
           echo " <tr>
            ...
            <td>$row[descr]</td>
            <td>
            <a class ='btn btn-success btn-sm' href='udtpl.php?idupl=$row[id_pl]'>edit</a>
            <a class ='btn btn-danger btn-sm' href='dltpl.php?iddepl=$row[id_pl]'>delete</a>
            </td>
        </tr>";
        }
