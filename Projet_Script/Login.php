...
#div2 #s2 {
    ...
    <body style="background-color: rgba(15, 23, 43, .9);">
        ...
        <div >
    <h2 style='color:#ffc40c ;'>List of users from database</h2>
    <!--<a  class="btn btn-primary" href="create.php" role="button">Signup</a>-->
    <a   href="Signup2.php" role="button"><button>Add user</button></a>
       ...
       $clients = client::selectAllClients('client',$connex->conn);
        ...
        foreach($clients as $row) {
           echo " <tr>
            ...
            <td>$row[email]</td>
            <td>
            <a class ='btn btn-success btn-sm' href='udt.php?idup=$row[id_cl]'>edit</a>
            <a class ='btn btn-danger btn-sm' href='dlt.php?idde=$row[id_cl]'>delete</a>
            </td>
        </tr>";
        }
